...
This document tracks planned work that was attempted but abandoned, preserving rationale and lessons learned for future decisions.
...
All planned work from this point forward is actively tracked in root `TODO.md`, `DONE.md`, and `PROGRESS.md` files.
