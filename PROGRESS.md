...
Last Updated: 2026-08-11 (PR #236 opened — Takion ENOBUFS `select()` retry-chain hardening, v0.1.898, hardware validation pending; latency-metric truthfulness and PR #213 loss-accounting mislabel flagged as disputed findings, corrected in place below; hardware A/B validation of PRs #213/#215/#223 still VALIDATED, PR #227 pending soft-restart trigger, GH #221 inconclusive/benign)
