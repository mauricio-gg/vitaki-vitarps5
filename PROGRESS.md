...
- **Proposed GH #206 Work:**
  - Drain-deficit instrumentation in `lib/src/takion.c`
  - chiaki-ng-style loss-report capping (~10%) in `lib/src/congestioncontrol.c`
  - Controlled Wi-Fi proximity A/B testing (RSSI > 80)
