/* VENDORED: This is libvita2d's private utils.h (matrix math + utf8_to_ucs2).
 * It is NOT the chiaki networking utils in lib/src/utils.h.
 * Do not #include "utils.h" from vita/src/ files — include by full path or
 * use the public vita2d.h API instead. */
